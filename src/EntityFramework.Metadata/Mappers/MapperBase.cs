...
using EntityFramework.Metadata.Mappings;
...
namespace EntityFramework.Metadata.Mappers
{
    internal abstract class MapperBase
    {
        ...
        */
        ...
        private void ActuallyAddAProperty(EntityMap entityMap, EdmProperty edmProperty, string propName, string columnName,
            EdmMember edmMember)
        {
